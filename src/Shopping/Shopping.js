...
const image1 = require('../../assets/profiles/1.jpg');
const image2 = require('../../assets/profiles/2.jpg');
...
export default class Shopping extends React.Component{
  ...
  render() {
    ...
    const { profiles, currentProfile, prevProfile, nextProfile } = this.state;
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.cards}>
          ...
          >
            <Animated.View {...{ style }}>
              <Card {...{ likeOpacity, nopeOpacity }} profile={profiles} />
            </Animated.View>
          </PanGestureHandler>
        </View>
      </SafeAreaView>
